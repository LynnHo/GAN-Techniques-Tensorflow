...
CUDA_VISIBLE_DEVICES=0 python train.py --n_d 5 --n_g 1 --n_d_pre 100 --optimizer rmsprop --loss_mode wgan --gp_mode none --norm none --weights_norm weight_clip --model conv_64 --lr_d 0.00005 --lr_g 0.00005 --dataset celeba --experiment_name conv64_celeba_loss{wgan}_gp{none}_norm{none}_wnorm{weight_clip}
# wagn + wgan-gp
